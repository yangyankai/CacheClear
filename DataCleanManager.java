package com.wt.wutang.main.utils.file;
...
public class DataCleanManager {
    ...
    public static String cleanInternalCache(Context context) {
        String strCacheSize = FileSizeUtil.getAutoFileOrFilesSize(context.getCacheDir());
    ...
    private static void deleteFilesByDirectory(File directory) {
        ...
        if (directory != null && directory.exists() && directory.isDirectory()) {
            ...
            for (File item : directory.listFiles()) {
                Log.e("TAG", "deleteFilesByDirectory:  delete " + item.getAbsolutePath());
                item.delete();
            }
        }
    }
